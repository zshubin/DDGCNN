...
class OptInit:
    def __init__(self, sub, logger):
        ...
        parser.add_argument('--batch_size', default=16, type=int, help='mini-batch size (default:32)')                             #32
        ...
        # train args
        parser.add_argument('--total_epochs', default=500, type=int, help='number of total epochs to run')                        #2600
        ...
        parser.add_argument('--lr', default=0.001, type=float, help='initial learning rate')                                        #1e-3
