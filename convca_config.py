...
class OptInit:
    def __init__(self, sub, logger):
        ...
        parser.add_argument('--batch_size', default=32, type=int, help='mini-batch size (default:32)')                             #32
        ...
        # train args
        parser.add_argument('--total_epochs', default=100, type=int, help='number of total epochs to run')                        #2600
        ...
        parser.add_argument('--lr', default=0.001, type=float, help='initial learning rate')                                        #0.0008,
        ...
        parser.add_argument('--time_win', type=int, default=1.0, help='time window')
